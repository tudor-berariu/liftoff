...
class TestLiftoffCLI:
    ...
    def test_multiple_experiments_default_config_multiple_procs(self, method_scoped_directory):
    ...
    def test_multiple_experiments_default_config_multiple_procs_with_queue(self, method_scoped_directory):
        """This time we also run multiple subexperiments, but with half the nr of process so that we also have a queue."""
    ...
    def test_multiple_experiments_long_variable_names_config_multiple_procs(self, method_scoped_directory):
